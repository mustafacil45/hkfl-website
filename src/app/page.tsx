      ...
      <section id="hero" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center text-white">
          <motion.div
            ...
            style={{ background: 'rgba(2,132,199,0.85)', backdropFilter: 'blur(10px)' }}
          >
          ...
          >
            Halil Kale<br />
            <span style={{ color: '#38bdf8' }}>Fen Lisesi</span><br />
            Mezunlar Derneği
          </motion.h1>
        ...
        <motion.div
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50 scroll-indicator"
        >
          ...
          >
            {stats.map((stat) => (
              ...
              >
                ...
                >
                  <stat.icon size={22} style={{ color: '#0284c7' }} />
                </div>
                ...
                {[
                  ...
                  <div key={item.text} className="flex items-center gap-4 p-5 rounded-xl bg-gray-50">
                    <div
                      ...
                      style={{ background: 'rgba(2,132,199,0.08)' }}
                    >
                      <item.icon size={20} style={{ color: '#0284c7' }} />
                    </div>
