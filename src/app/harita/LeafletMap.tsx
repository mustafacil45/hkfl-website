  ...
  return (
    <>
      <style>{`
        ...
        .leaflet-control-zoom { border:1px solid rgba(255,255,255,0.1) !important; border-radius:6px !important; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.4) !important; }
        ...
        .leaflet-control-attribution { background:rgba(15,23,42,0.8) !important; color:#475569 !important; font-size:9px !important; border-radius:4px 0 0 0 !important; padding:2px 8px !important; }
        .leaflet-control-attribution a { color:#64748b !important; }
        .leaflet-popup-content-wrapper { background:rgba(15,23,42,0.95) !important; color:#e2e8f0 !important; border-radius:6px !important; border:1px solid rgba(255,255,255,0.2) !important; box-shadow:0 8px 32px rgba(0,0,0,0.5) !important; backdrop-filter:blur(12px); padding:0 !important; }
            ...
            <CircleMarker key={loc.id} center={[loc.lat, loc.lng]} radius={isSelected ? radius + 3 : radius}
              ...
              <Popup>
                <div style={{ padding:'14px 16px', minWidth:'190px' }}>
                  ...
                  <div style={{ background:'rgba(255,255,255,0.08)', borderRadius:'6px', padding:'8px 12px', marginBottom:'10px', border:'1px solid rgba(255,255,255,0.12)' }}>
