import { buildSectors, type Sector } from './sectors';
...
/**
 * Ham veri: `count` her zaman `roles` içindeki kişi sayılarının toplamına eşittir.
 * Sektör yüzdeleri buradan türetilir, elle tutulmaz.
 */
type RawCity = Omit<CityData, 'sectors'>;
...
const rawCities: RawCity[] = [
  ...
  },
  {
    ...
    roles: [
      ...
      "Kimya Mühendisliği (2)",
      "Makina Mühendisliği (2)",
      "Havacılık Ve Uzay Mühendisliği (2)",
      "Elektrik-elektronik Mühendisliği",
      "İşletme",
      "Elektronic Engineer",
      "Elektronik Mühendisliği",
...
export const citiesData: CityData[] = rawCities.map((city) => ({
  ...city,
  sectors: buildSectors(city.roles),
}));
